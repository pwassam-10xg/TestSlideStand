...
class Ui_TestSlideStand(object):
    def setupUi(self, TestSlideStand):
        ...
        TestSlideStand.resize(1489, 770)
        ...
        self.label_angle_dep = QtWidgets.QLabel(self.centralwidget)
        self.label_angle_dep.setMinimumSize(QtCore.QSize(100, 0))
        self.label_angle_dep.setText("")
        self.label_angle_dep.setObjectName("label_angle_dep")
        self.gridLayout.addWidget(self.label_angle_dep, 1, 11, 1, 1)
        ...
        self.gridLayout.addLayout(self.gridLayout_2, 2, 0, 1, 16)
        ...
        self.label_spatial_dep = QtWidgets.QLabel(self.centralwidget)
        self.label_spatial_dep.setMinimumSize(QtCore.QSize(100, 0))
        self.label_spatial_dep.setText("")
        self.label_spatial_dep.setObjectName("label_spatial_dep")
        self.gridLayout.addWidget(self.label_spatial_dep, 1, 13, 1, 1)
    ...
    def retranslateUi(self, TestSlideStand):
        ...
        self.label_7.setText(_translate("TestSlideStand", "Spatial dependence:"))
        ...
        self.label_5.setText(_translate("TestSlideStand", "Angle dependence:"))
